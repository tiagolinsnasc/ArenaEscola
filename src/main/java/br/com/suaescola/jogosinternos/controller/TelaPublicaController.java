 ...
 * controle. Reaproveitada por futsal e vôlei -- cada equipe tem seu
 * próprio log de eventos, exibido logo abaixo do escudo e nome dela.
 * Todo o conteúdo é ligado (bind) ao EstadoPartida compartilhado com a
 * tela de controle -- atualiza sozinho, sem consultar o banco.
 */
public class TelaPublicaController {
